...
LocalRestaurant localRestaurantFromJson(String str) => LocalRestaurant.fromJson(json.decode(str));

String localRestaurantToJson(LocalRestaurant data) => json.encode(data.toJson());
